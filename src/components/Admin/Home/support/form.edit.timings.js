          ...
          <div className="row">
            <div className="col-6">
              <input
                ...
                className="form-control"
                value={
                  userData?.holidays_working?.holiday_work_from
                    ? userData?.holidays_working?.holiday_work_from
                    : business.holiday_work_from || ""
                }
                onChange={(e) =>
                  setuserData({
                    ...userData,
            ...
            <div className="col-6">
              <input
                ...
                className="form-control"
                value={
                  userData?.holidays_working?.holiday_work_to
                    ? userData?.holidays_working?.holiday_work_to
                    : business.holiday_work_to || ""
                }
                onChange={(e) =>
                  setuserData({
                    ...userData,
...
export default FormEditTimings;
